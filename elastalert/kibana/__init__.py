...
dashboard_temp = {
    ...
    "panel_hints": True,
    "pulldowns": [
        {"collapse": False, "enable": True, "notice": True, "type": "filtering"}
    ],
    "refresh": False,
    "rows": [
        {
            ...
            "panels": [
                {
                    ...
                    "tooltip": {"query_as_alias": True, "value_type": "cumulative"},
                    "type": "histogram",
                    "value_field": None,
                    "x-axis": True,
                    "y-axis": True,
...
def add_filter(dashboard, es_filter):
    ...
    kibana_filter = {"active": True, "alias": "", "id": next_id, "mandate": "must"}
...
def filters_from_dashboard(db):
    ...
    for filter in list(filters.values()):
        ...
        if filter_type == "range":
            config_filter = {
                "range": {filter["field"]: {"from": filter["from"], "to": filter["to"]}}
            }
